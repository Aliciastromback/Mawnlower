...
user1 = User.new do |u|
  ...
  u.photos.attach(io: file2, filename: 'logo.png', content_type: 'image/png')
end
user1.save
...
user2 = User.new do |u|
  ...
  u.password_confirmation = "123456"
  u.address = "Sonntagstraße 1, Berlin, Berlin, Deutschland"
  u.photos.attach(io: file1, filename: 'sebi.png', content_type: 'image/png')
end
user2.save
...
user3 = User.new do |u|
  ...
  u.password_confirmation = "123456"
  u.address = "Sonntagstraße 1, Berlin, Berlin, Deutschland"
  u.photos.attach(io: file3, filename: 'stormbreaker.png', content_type: 'image/png')
end
user3.save
...
lawnmower2 = Lawnmower.new do |u|
  ...
  u.speed = 5
  u.photos.attach(io: file3, filename: 'doggo.jpg', content_type: 'image/jpg')
end
